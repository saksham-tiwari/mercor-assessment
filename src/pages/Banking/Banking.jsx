  ...
  return (
    <div id="BankingSection">
      ...
      <div className='textDiv'>
        ...
        <img src="/assets/banking-stairs-1.png" alt="bankingStairs1" className='bankingStairs1'/>
        <img src="/assets/banking-stairs-2.png" alt="bankingStairs2" className='bankingStairs2'/>
        <img src="/assets/banking-ramp-1.png" alt="bankingRamp1" className='bankingRamp1'/>
        <img src="/assets/banking-ramp-2.png" alt="bankingRamp2" className='bankingRamp2'/>
        <img src="/assets/banking-track-1.png" alt="bankingTrack1" className='bankingTrack1'/>
        <img src="/assets/banking-track-2.png" alt="bankingTrack2" className='bankingTrack2'/>
        <img src="/assets/banking-track-2.png" alt="bankingTrack2" className='bankingTrack2'/>
